    ...
    try:
        if '.pdf' not in path :
            ...
            if '.tif' in path:
                ...
                #convert_jpg_to_pdf(path, copy_path_tiff)
                # 加密6020
                ...
                #convert_jpg_to_pdf(path, copy_path_jpg)
                # 加密6020
        ...
        if '.pdf' not in path :
            ...
            if '.tif' in path:
                # 改變圖像的大小並保存結果
                #resize_image(path, 'resized_image.tiff', (w, h))
                # 轉存PDF
                #convert_jpg_to_pdf('resized_image.tiff', copy_path_tiff)
                convert_jpg_to_pdf(path, copy_path_tiff)
                # 加密6020
                ...
                # 改變圖像的大小並保存結果
                #resize_image(path, 'resized_image.jpg', (w, h))
                # 轉存PDF
                #convert_jpg_to_pdf('resized_image.jpg', copy_path_jpg)
                convert_jpg_to_pdf(path, copy_path_jpg)
                # 加密6020
